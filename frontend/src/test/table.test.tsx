...
test('renders a header per dimension plus vendor + verdict', () => {
  render(<VendorTable rows={[]} onSelect={() => {}} onDelete={() => {}} onRename={() => {}} onResume={() => {}} />)
...
test('renders a scored row and fires onSelect on click', async () => {
  ...
  render(<VendorTable rows={[row]} onSelect={onSelect} onDelete={() => {}} onRename={() => {}} onResume={() => {}} />)
...
test('a streaming row shows a pending indicator', () => {
  ...
  render(<VendorTable rows={[row]} onSelect={() => {}} onDelete={() => {}} onRename={() => {}} onResume={() => {}} />)
